...
function ForgotPasswordModal({ isOpen, onClose, onSwitchToLogin }) {
    ...
    const captchaCode = '17152'; // Giả lập captcha

    if (!isOpen) return null;

    const handleSubmit = (e) => {
        e.preventDefault();
        console.log('Gửi yêu cầu quên mật khẩu:', { email, captcha });
    };
    ...
    return (
        <div className={cx('modal-overlay')} onClick={onClose}>
            <div className={cx('modal-content')} onClick={(e) => e.stopPropagation()}>
                ...
                <h2 className={cx('modal-title')}>QUÊN MẬT KHẨU</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className={cx('submit-btn', 'orange', 'full-width')}>
                        Gửi
                    </button>

                    <div className={cx('form-footer', 'center')}>
